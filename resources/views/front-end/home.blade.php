...
<section class="latest-blog objects-car white-bg page page-section-ptb">
 <div class="objects-left"><img class="img-fluid objects-1" src="{{asset('front-end\images\objects\03.jpg')}}" alt=""></div>
 <div class="objects-right"><img class="img-fluid objects-2" src="{{asset('front-end\images\objects\04.jpg')}}" alt=""></div>
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="section-title">
    ...
    <div class="blog-1">
      <div class="row">
        <div class="col-md-6">
          <img class="img-fluid" src="{{asset('front-end\images\blog\01.jpg')}}" alt="">
        </div>
        <div class="col-md-6">
          <div class="blog-content">
            <a class="link" href="#">Porsche 911 is text of the printin   a galley of type and bled it to make a type specimen book. </a>
            <span class="uppercase">November 29, 2017  | <strong class="text-red">post by john doe </strong></span>
   ...
   <div class="row">
    <div class="col-md-12">
      ...
      <div class="item">
        <div class="testimonial-block text-center">
           <div class="testimonial-image">
             <img class="img-fluid" src="{{asset('front-end\images\testimonial\01.jpg')}}" alt="">
           </div> 
     ...
     <div class="item">
        <div class="testimonial-block text-center">
           <div class="testimonial-image">
             <img class="img-fluid" src="{{asset('front-end\images\testimonial\02.jpg')}}" alt="">
           </div> 
           <div class="testimonial-box">
             <div class="testimonial-avtar">
      ...
      <div class="item">
        <div class="testimonial-block text-center">
           <div class="testimonial-image">
             <img class="img-fluid" src="{{asset('front-end\images\testimonial\03.jpg')}}" alt="">
           </div> 
           <div class="testimonial-box">
             <div class="testimonial-avtar">
      ...
      <div class="item">
        <div class="testimonial-block text-center">
           <div class="testimonial-image">
             <img class="img-fluid" src="{{asset('front-end\images\testimonial\04.jpg')}}" alt="">
           </div> 
           <div class="testimonial-box">
             <div class="testimonial-avtar">
