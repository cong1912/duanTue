...
<div class="container">
  ...
  <!-- SLIDE  -->
    ...
    <!-- MAIN IMAGE -->
        <img src="{{asset('front-end/revolution/assets/ac5dd-02.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina="">
    <!-- LAYERS -->
...
chỉ với 1.000.000 Đ </div>
    ...
    <!-- LAYER NR. 5 -->
    <div class="tp-caption   tp-resizeme" id="slide-4-layer-2" data-x="62" data-y="348" data-width="['657']" data-height="['auto']" data-type="text" data-responsive_offset="on" data-frames='[{"delay":1720,"speed":1070,"frame":"0","from":"x:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"nothing"}]' data-textalign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 6; min-width: 657px; max-width: 657px; white-space: normal; font-size: 14px; line-height: 24px; font-weight: 400; color: rgba(255, 255, 255, 1.00);font-family:Open Sans;">Tận tâm vì sự an toàn! Giáo viên 1 kèm 1, thủ tục đơn giản, giờ học tự chọn, hỗ trợ thi lại trong ngày. hoàn tiền 200% nếu phát sinh phí. Học nhanh - Thi sớm -  Có bằng ngay. </div>
       ...
       <div class="item">
         ...
         <div class="row">
           <div class="col-md-3">
            <div class="testimonial-avtar">
              <img class="img-fluid center-block" src="{{asset('front-end\images\home\2.jpg')}}" alt="">
            </div>   
           </div>  
           <div class="col-lg-9 col-md-9 col-sm-9">
             <div class="testimonial-content">
               <p><i class="fa fa-quote-left"></i> <span>Thực hành lái xe b2 mình hay bị lỗi chạy lên dốc cầu. Nhưng khi được các thầy tại 3T Sai Gon hướng dẫn tận tâm mình đã khắc phục lỗi này trong ngày.</span> <i class="fa fa-quote-right float-right"></i></p>
             </div> 
        ...
        <div class="testimonial-block">
         <div class="row">
           <div class="col-md-3">
            <div class="testimonial-avtar">
              <img class="img-fluid center-block" src="{{asset('front-end\images\home\3.jpg')}}" alt="">
            </div>   
           </div>  
           <div class="col-lg-9 col-md-9 col-sm-9">
             <div class="testimonial-content">
               <p><i class="fa fa-quote-left"></i> <span>Sân tập tại Saigon3t được thiết kế theo tiêu chuẩn của Bộ GTVT và chuẩn Singapore nên rất dễ dàng đánh lái khi áp dụng lý thuyết được học .vào thực hành.</span> <i class="fa fa-quote-right float-right"></i></p>
             </div> 
             <div class="testimonial-info">
       ...
       <div class="item">
        <div class="testimonial-block">
         <div class="row">
           <div class="col-md-3">
            <div class="testimonial-avtar">
              <img class="img-fluid center-block" src="{{asset('front-end\images\home\4.jpg')}}" alt="">
            </div>   
           </div>  
           <div class="col-lg-9 col-md-9 col-sm-9">
             <div class="testimonial-content">
               <p><i class="fa fa-quote-left"></i> <span>Khi học lái xe tại trung tâm Saigon3t mình cảm thấy rất thoải mái vì có thể sắp xếp thời gian và chọn lịch học phù hợp với công việc mình đang làm. </span> <i class="fa fa-quote-right float-right"></i></p>
             </div> 
             <div class="testimonial-info">
              <h6>VŨ TRỌNG TUYỂN
              </h6>
