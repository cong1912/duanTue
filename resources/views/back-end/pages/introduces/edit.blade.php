                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h4>Form upload giới thiệu</h4>
                                    </div>
                                </div>
                            </div>
                            <form  method="post" action="{{ route('introduces.update',$introduce) }}" autocomplete="off" enctype="multipart/form-data">
                                <div class="widget-content widget-content-area container">
                                    @csrf
                                    @method('put')
                                    <div class="form-group{{ $errors->has('content') ? ' has-danger' : '' }} ">
                                        <p>nội dung </p>
                                        <textarea class="form-control" name="content" required id="aboutBio" placeholder="nội dung " rows="10" >{{$introduce->content}}</textarea>
                                    </div>
