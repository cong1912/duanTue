                    ...
                    <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                <form id="general-info" method="post" action="{{ route('news.update',$new) }}" autocomplete="off" enctype="multipart/form-data" class="section general-info">
                                    <div class="info">
                                        @csrf
                                        @method('put')
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-2 col-lg-12 col-md-4">
                                                        <div class="upload mt-4 pr-md-4{{ $errors->has('image') ? ' has-danger' : '' }}">
                                                            <input type="file" id="input-file-max-fs" name="image"  class="dropify{{ $errors->has('image') ? ' is-invalid' : '' }}" data-default-file="/images/{{$new->image}}" data-max-file-size="2M">
                                                    ...
                                                    <div class="col-xl-10 col-lg-12 col-md-8 mt-md-0 mt-4">
                                                        <div class="form">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                                                        ...
                                                                        <input type="text" class="form-control mb-6" name="title" id="title" value="{{$new->title}}" required placeholder="tên phần mềm">
                                                            ...
                                                            <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                                                ...
                                                                <input type="text" class="form-control mb-6" name="slug" id="title" required  value="{{$new->slug}}" placeholder="slug vd:mot-hai">
                                                                @include('alerts.feedback', ['field' => 'title'])
                                                            </div>

                                                            <div class="form-group editor-container{{ $errors->has('tomtat') ? ' has-danger' : '' }}">
                                                                <label for="aboutBio">Nội dung tóm tắt</label>
                                                                <textarea class="ckeditor" name="tomtat" id="aboutBio" required  cols="80" rows="10" >{!!$new->tomtat!!}</textarea>
